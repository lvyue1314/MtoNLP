...
# # Gemma 4 E4B
# MODEL_DIR="$WORKSPACE/models/google/gemma-4-E4B-it"
# if [ ! -d "$MODEL_DIR" ]; then
#     echo "下载 Gemma 4 E4B..."
#     modelscope download --model google/gemma-4-E4B-it --local_dir "$MODEL_DIR"
#     echo "✅ Gemma 4 下载完成"
# else
#     echo "✅ Gemma 4 模型已存在"
# fi
...
# # LLaVA 1.5-7B
# LLAVA_DIR="$WORKSPACE/models/swift/llava-1.5-7b-hf"
# if [ ! -d "$LLAVA_DIR" ]; then
#     echo ""
#     echo "下载 LLaVA 1.5-7B..."
#     pip install huggingface_hub
#     export HF_ENDPOINT=https://hf-mirror.com
#     hf download llava-hf/llava-1.5-7b-hf \
#         --local-dir /MtoNLP/models/swift/llava-1.5-7b-hf
#     echo "✅ LLaVA 下载完成"
# else
#     echo "✅ LLaVA 模型已存在"
# fi
